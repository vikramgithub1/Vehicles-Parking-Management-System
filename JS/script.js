...
class Entry{
    constructor(owner,contact,vehicle,licensePlate,model,entryTime,lot, charge,entryDate,exitDate){
        this.owner = owner;
...
class UI{
    ...
    static validateInputs(){
        ...
        if(owner === '' || contact === '' || vehicle === '' || licensePlate === '' || model === '' || entryTime === '' || lot === '' || charge === '' || entryDate === '' || exitDate === ''){
...
//Event Add
    document.querySelector('#entryForm').addEventListener('submit',(e)=>{
        ...
        //Instatiate Entry
        const entry = new Entry(owner,contact, vehicle, licensePlate, model, entryTime, lot, charge, entryDate, exitDate);
